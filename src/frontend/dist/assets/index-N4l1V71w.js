  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        price: "৳650",
        image: "/assets/uploads/image-019d2839-9a54-716b-afa9-643894bc53f1-1.png"
      },
      {
...
function PlantPlaceholder({ name }) {
  const initials = name.split(" ").map((w) => w[0]).join("").slice(0, 2).toUpperCase();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-green-50 to-green-100", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-4xl mb-2", children: "🪴" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-brand-green/60 tracking-wider", children: initials })
  ] });
}
function ProductCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 pb-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              ) : /* @__PURE__ */ jsxRuntimeExports.jsx(PlantPlaceholder, { name: product.name }),
              product.bestSeller && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-2.5 right-2.5 bg-brand-gold text-white text-[10px] font-bold uppercase tracking-widest px-2.5 py-1 rounded-full shadow-gold", children: "Best Seller" })
            ]
          }
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 flex flex-col flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-base leading-snug mb-1", children: product.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs leading-relaxed flex-1 mb-3", children: product.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mt-auto mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand-gold font-bold text-lg font-serif", children: product.price }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wider text-muted-foreground", children: "Qty:" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center border border-border rounded-full overflow-hidden", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 text-center text-sm font-semibold text-foreground", children: qty }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
...
function StarRating({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1", children: [1, 2, 3, 4, 5].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      type: "button",
      onClick: () => onRate == null ? void 0 : onRate(s),
      className: `transition-colors ${s <= rating ? "text-brand-gold" : "text-muted-foreground/30"} ${onRate ? "hover:text-brand-gold cursor-pointer" : "cursor-default"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-4 h-4 fill-current" })
    },
    s
  )) });
}
function OrderDetailsPage({
  ...
  const [form, setForm] = reactExports.useState({ name: "", phone: "", address: "" });
  ...
  function sendOrder() {
    ...
    const productText = cart.map((item) => `${item.name} x${item.qty} (৳${item.price} each)`).join(", ");
...
🛒 Product: ${productText}`;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto px-4 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-serif text-3xl sm:text-4xl font-bold text-foreground mb-2", children: "Order Details" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-0.5 bg-brand-gold mb-10" }),
    cart.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-2xl font-bold text-foreground mb-2", children: "Your cart is empty" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm mb-6", children: "Add some beautiful plants to get started!" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-3xl shadow-card border border-border/60 overflow-hidden mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-4 border-b border-border bg-brand-green/5", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-xl font-bold text-foreground", children: "Cart Summary" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", children: cart.map((item, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-6 flex-shrink-0 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground", children: [
                  "x",
                  item.qty
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground w-20 text-right", children: [
                  "৳",
                  item.price,
                  " each"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-foreground w-20 text-right", children: [
                  "৳",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-6 py-4 border-t border-border bg-brand-gold/5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif font-bold text-foreground text-lg", children: "Total" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-serif font-bold text-brand-gold text-xl", children: [
            "৳",
            total.toLocaleString()
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-3xl shadow-card border border-border/60 p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-xl font-bold text-foreground mb-6", children: "Your Details" }),
...
function App() {
  ...
  const shopRef = reactExports.useRef(null);
  ...
  function addToCart(name, price, qty) {
    setCart((prev) => {
      ...
      if (existing) {
        return prev.map(
          (i) => i.name === name ? { ...i, qty: i.qty + qty } : i
        );
      }
  ...
  const handleReviewSubmit = async (e) => {
    ...
    if (!reviewForm.name || !reviewForm.message) {
      ue.error("Please fill in your name and message.");
      return;
    }
    setSubmitting(true);
    try {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background font-sans", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster, { position: "top-right" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 bg-brand-green w-full" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-border shadow-xs", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              children: [
                ...
                cartCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-1 -right-1 w-5 h-5 rounded-full bg-brand-gold text-white text-[10px] font-bold flex items-center justify-center shadow-gold", children: cartCount > 99 ? "99+" : cartCount })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-white border-t border-border px-4 py-4 flex flex-col gap-3", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          onClick: () => {
    ...
    page === "order" ? /* @__PURE__ */ jsxRuntimeExports.jsx(
      OrderDetailsPage,
      {
        cart,
        setPage,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center text-white px-4 py-24 max-w-4xl mx-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "inline-block border border-white/50 text-white/90 text-xs font-semibold uppercase tracking-[0.2em] px-4 py-1.5 rounded-full mb-6 backdrop-blur-sm bg-white/10", children: "Premium Botanical Store" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-serif text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-6", children: [
                "Transform Your Space",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                "with Nature's Luxury"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/85 text-lg sm:text-xl mb-10 max-w-2xl mx-auto leading-relaxed", children: "Premium plants and gardening essentials for a healthier, greener life" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          ref: shopRef,
          children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 py-3 overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 min-w-max", children: CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "features", className: "bg-background py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 lg:grid-cols-4 gap-6", children: FEATURES.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: "flex flex-col items-center text-center p-6 bg-card rounded-2xl shadow-xs border border-border/60",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-brand-green/10 flex items-center justify-center text-brand-green mb-4", children: f.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-sm text-foreground mb-1 leading-snug", children: f.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs leading-relaxed", children: f.desc })
          ]
        },
        f.id
      )) }) }) }),
      CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: cat.id, className: "py-16 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-brand-gold text-xs font-bold uppercase tracking-[0.2em] mb-2", children: "Shop Now" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl sm:text-4xl font-bold text-foreground", children: cat.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-0.5 bg-brand-gold mx-auto mt-4" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: cat.products.map((product, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ProductCard,
          {
            product,
            index: idx,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-background py-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-brand-gold text-xs font-bold uppercase tracking-[0.2em] mb-2", children: "Reviews" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl sm:text-4xl font-bold text-foreground", children: "What Our Customers Say" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-0.5 bg-brand-gold mx-auto mt-4" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6 mb-16", children: REVIEWS.map((review) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-foreground/80 text-sm leading-relaxed mt-4 flex-1 italic font-serif", children: [
                "“",
                review.text,
                "”"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mt-6 pt-5 border-t border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-full bg-brand-green/15 flex items-center justify-center text-brand-green font-bold text-sm flex-shrink-0", children: review.initials }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-sm text-foreground", children: review.name })
              ] })
            ]
          },
          review.id
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto bg-card rounded-3xl shadow-card p-8 border border-border/60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-2xl font-bold text-foreground mb-2 text-center", children: "Share Your Experience" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm text-center mb-8", children: "We'd love to hear from you" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleReviewSubmit, className: "space-y-5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs font-semibold uppercase tracking-wider text-muted-foreground mb-2 block", children: "Rating" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                StarRating,
                {
                  rating: reviewForm.rating,
                  onRate: (r2) => setReviewForm((p) => ({ ...p, rating: r2 }))
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-white py-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-brand-gold text-xs font-bold uppercase tracking-[0.2em] mb-2", children: "Hassle-Free" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl sm:text-4xl font-bold text-foreground", children: "Delivery & Payment" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-0.5 bg-brand-gold mx-auto mt-4" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-6", children: PAYMENT_OPTIONS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex flex-col items-center text-center p-8 rounded-3xl border border-border bg-background shadow-card",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-brand-green/10 flex items-center justify-center text-brand-green mb-5", children: item.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif font-bold text-lg text-foreground mb-2", children: item.title }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "bg-brand-green py-20 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-brand-gold text-xs font-bold uppercase tracking-[0.2em] mb-3", children: "We're Here" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-serif text-3xl sm:text-4xl font-bold text-white mb-4", children: "Get In Touch" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/70 mb-12 text-sm", children: "Reach out to us via any of the channels below" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12", children: CONTACT_ITEMS.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: item.href,
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 rounded-full bg-brand-gold/20 flex items-center justify-center text-brand-gold flex-shrink-0", children: item.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-xs uppercase tracking-wider mb-0.5", children: item.label }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold text-sm group-hover:text-brand-gold transition-colors", children: item.value })
              ] })
            ]
          },
          item.id
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-brand-green text-white/80 py-12 px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-10 mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white/60 text-sm italic font-serif", children: "Bringing Nature Closer to You" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-semibold text-xs uppercase tracking-widest mb-4", children: "Quick Links" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2", children: FOOTER_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-white font-semibold text-xs uppercase tracking-widest mb-4", children: "Follow Us" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                "aria-label": "Facebook",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiFacebook, { className: "w-4 h-4" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                className: "w-9 h-9 rounded-full bg-white/10 hover:bg-brand-gold/80 flex items-center justify-center transition-colors",
                "aria-label": "WhatsApp",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(SiWhatsapp, { className: "w-4 h-4" })
              }
            )
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-white/40", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
          "© ",
          (/* @__PURE__ */ new Date()).getFullYear(),
          " Verdant. All rights reserved."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
